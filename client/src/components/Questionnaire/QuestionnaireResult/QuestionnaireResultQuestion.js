export const QuestionnaireResultQuestion = ({ ...props }) => {
                ...
                return question.max === 1 ? (
                  ...
                  >
                    <input
                      ...
                      checked={answers.selection ? answers.selection === option.id : false}
                      disabled={true}
                  ...
                  >
                    <input
                      type="checkbox"
                      className="custom-control-input"
                      checked={answers.options ? answers.options[option.id - 1] === true : false}
                      disabled={true}
                      id={option.id}
                    />
                    <label className="custom-control-label" htmlFor={option.id}>
...
export default QuestionnaireResultQuestion;
